                    ...
                    <div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                        {pairedEvents.map(({ id, goal, assist }) => {
                          if (goal) {
                            return (
                              <div key={id} style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 14px', borderRadius: '10px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                                ...
                                <span style={{ color: '#fff', fontSize: '0.9rem', fontWeight: '600' }}>{goal.player?.name || 'Unknown'}</span>
                                {assist && (
                            ...
                            return (
                              <div key={id} style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 14px', borderRadius: '10px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)' }}>
                                ...
                                <span style={{ color: '#fff', fontSize: '0.9rem', fontWeight: '600' }}>{assist.player?.name || 'Unknown'}</span>
                              </div>
                            );
                          }
                        })}
